...
- Schauen Sie sich dazu erst einmal das Beispiel in der Dokumentation an: <http://docs.sencha.com/extjs/6.2.0/classic/Ext.tree.Panel.html>
...
- Dafür muss der allgemeine `Ext.data.TreeStore` durch den
  [GeoExt.data.store.LayersTree](https://geoext.github.io/geoext3/master/docs/#!/api/GeoExt.data.store.LayersTree) ausgetauscht werden.
...
- Für die Erstellung eines beispielhaften Ext Grids machen Sie sich mit der Dokumentation vertraut: <http://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html>
...
- Das jeweilige selektierte Feature im Grid/Tabelle sollte auf der Karte hervorgehoben werden. Verwenden Sie dazu die optional Konfiguration `listeners`: <http://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html#cfg-listeners>
